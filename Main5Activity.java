...
public class Main5Activity  extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    private FirebaseDatabase mty;
    //private ArrayList<String> mmlistview = new ArrayList<>();
    private ListView mlistview;
    String userid;
    ArrayAdapter adapter;
    String u="u3P8252LutMHUu6nWsrUgCka4BQ2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(String name : HashMapForURL.keySet()){
            ...
            TextSliderView textSliderView = new TextSliderView(Main5Activity.this);
        ...
        sliderLayout.addOnPageChangeListener(Main5Activity.this);
        mref = FirebaseDatabase.getInstance();
        mty=FirebaseDatabase.getInstance();
...
//                arrayAdapter.notifyDataSetChanged();
        ...
        mref.getReference("user").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // This method is called once with the initial value and again
                // whenever data at this location is updated.
                showDatas(dataSnapshot);
            }
        ...
        final Query userQuery = mref.getReference().orderByChild("id");
...
//String values=.
            ...
            //        Toast.makeText(getApplicationContext(),value,Toast.LENGTH_LONG).show();
                        mty.getReference().addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                // This method is called once with the initial value and again
                                // whenever data at this location is updated.
    ...
    private void showData(DataSnapshot dataSnapshot) {
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            uInfo.setid(ds.child(u).getValue(UserInformation.class).getid()); //set the name
            uInfo.setbalance(ds.child(u).getValue(UserInformation.class).getbalance()); //set the phone_num
            ...
            //String a=ds.getkey();
//int y=Integer.parseInt(uInfo.getid());
            //          if(y==2){

            String a=uInfo.getid();
            Toast.makeText(getApplicationContext(),a,Toast.LENGTH_LONG).show();
            /*array.add("username"+uInfo.getid());
    ...
    private void showDatas(DataSnapshot dataSnapshot) {
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            UserInformation uInfo = new UserInformation();
            //          uInfo.setemail(ds.getValue(UserInformation.class).getemail()); //set the email
            uInfo.setid(ds.getValue(UserInformation.class).getid()); //set the name
            uInfo.setbalance(ds.getValue(UserInformation.class).getbalance()); //set the phone_num
...
//int y=Integer.parseInt(uInfo.getid());
  //          if(y==2){
    ...
    public void AddImagesUrlOnline(){
        ...
        HashMapForURL.put("favourite star", "https://firebasestorage.googleapis.com/v0/b/hellofire-7180f.appspot.com/o/920d9d5be5796de24d37338bc6ec8aa3.jpg?alt=media&token=dd3791f6-78cd-4182-a248-4aae51c58e93");
